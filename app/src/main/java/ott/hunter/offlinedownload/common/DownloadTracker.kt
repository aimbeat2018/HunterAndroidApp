package ott.hunter.offlinedownload.common
...
import ott.hunter.R
import ott.hunter.adapters.EpisodeAdapterKo
...
class DownloadTracker(context: Context, private val httpDataSourceFactory: HttpDataSource.Factory, private val downloadManager: DownloadManager) {
    ...
    fun addListener(listener: EpisodeAdapterKo) {
    ...
    fun toggleDownloadPopupMenu(context: Activity, anchor: EpisodeAdapterKo, uri: Uri?) {
